...
const FilteringCollection = require('hp-autonomy-js-whatever/src/js/filtering-collection');
const template = require('../templates/databases-view.html');
...
module.exports = Backbone.View.extend(/**@lends module:databases-view/js/databases-view.DatabasesView.prototype */{
    /**
